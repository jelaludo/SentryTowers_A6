...
| `sol82/` | Contract candidate | Syzygy D0 detailed/game/static-distance tiers, six clips, seven materials and sampled firing clearance validate. Legacy controller/socket migration, game release compression, laser-lab cameras, thresholds and phone review remain pending. |
