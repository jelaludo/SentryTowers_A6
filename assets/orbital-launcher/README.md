...
| Time | Action |
| --- | --- |
| 0–8 s | Slow loading approach reaches the first rung at 8 s |
| 4–8 s | Capacitor lights charge while loading continues |
| 8–8.4 s | First rung lights; 10× faster launch along the curve, with synchronized clamps and lights |
| 8.4–16 s | Payload separates rapidly; sled brakes in the recovery extension and holds |
