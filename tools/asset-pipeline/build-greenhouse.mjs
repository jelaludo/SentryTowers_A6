...
import {buildModel,definitions} from './greenhouse-shape.mjs';
const out=new URL('../../assets/greenhouse/',import.meta.url);
...
const manifest={schema:'jelaludo.asset-family/v2-candidate',family:'greenhouse',label:'VER-01 / Greenhouse operation',status:'contract_candidate_pending_game_review',plain_glb_source_of_truth:true,coordinate_system:{units:'meters',up:'+Y',forward:'+Z',origin:'ground at plot centre'},supported_damage_levels:[0],missing_damage_states_reason:'D1–D3 unauthored; damage is independent from detail.',budgets:{lod1:{triangles:8000,draw_calls:10,bytes:400000},lod2:{triangles:3000,draw_calls:1,bytes:250000}},lod_selection:{initial:2,approach_distance_m:150,hysteresis_m:20,provisional:true,detailed:'Manual recording and close inspection',distance:'Static rest pose; retain LOD1 during service motion.'},runtime:{adapter:'runtime.js',baked_clips:[],demonstration:{name:'Cultivation_Service_Cycle',duration_s:20,loop:true},scope:'Recirculating cultivation demonstration: irrigation gantry, climate fan and harvest access. Engine pivots are unbaked; plant growth and inventory are game-owned.'},assets};
