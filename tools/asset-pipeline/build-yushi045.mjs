...
function build(lod){
 ...
 const body=[],glass=[],handle=[],root=new T.Group();root.name='ROOT';root.userData={family:'yushi045_container',designation:'Yushi045',lod,damage_level:0,fill_default:.5,units:'meters',up:'+Y',forward:'+Z',origin:'ground plot centre'};
