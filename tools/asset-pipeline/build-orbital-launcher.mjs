...
import {buildModel,definitions} from './orbital-launcher-shape.mjs';
const out=new URL('../../assets/orbital-launcher/',import.meta.url);
...
const manifest={schema:'jelaludo.asset-family/v2-candidate',version:1,family:'orbital-launcher',label:'ARC-01 / Orbital collector launch complex',status:'contract_candidate_pending_game_camera_reference_phone',plain_glb_source_of_truth:true,coordinate_system:{units:'meters',up:'+Y',forward:'+Z',origin:'ground/packed docking datum at plot centre'},supported_damage_levels:[0],missing_damage_states_reason:'First intact asset family; D1–D3 not authored.',manufacturer_lineage:['ISAO','MORK','KORP'],budgets:{lod1:{triangles:8000,draw_calls:10,bytes:400000},lod2:{triangles:3000,draw_calls:1,bytes:250000}},lod_selection:{initial:2,approach_distance_m:150,hysteresis_m:20,provisional:true,detailed:'Manual close shots and recording',distance:'Static docked launcher and packed satellite; no articulation or pose matching. Keep LOD1 throughout active launch and deployment.'},runtime:{adapter:'runtime.js',baked_clips:[],demonstration:{name:'Collector_Launch',duration_s:30,loop:false,events:[{time_s:0,event:'LOAD'},{time_s:4,event:'CHARGE'},{time_s:8,event:'ACCELERATE'},{time_s:12,event:'RELEASE'},{time_s:16,event:'SLED_RETURN'},{time_s:17,event:'DEPLOY_COLLECTOR'},{time_s:21,event:'INSERTION_STAGE'},{time_s:26,event:'COLLECTOR_READY'},{time_s:30,event:'COMPLETE'}]},engine_driven:['LAUNCH_SLED','CLAMP_L','CLAMP_R','PETAL_1_HINGE','PETAL_2_HINGE','PETAL_3_HINGE','PETAL_4_HINGE','PETAL_5_HINGE','PETAL_6_HINGE','INSERTION_PLUME'],scope:'Kinematic model demonstration, not electromagnetic, atmospheric or orbital physics. Rail dimensions and time are art-directed. Satellite insertion stage is visual only; no claim of reaching orbit.',rail:{radius_m:40,sweep_rad:1.05,curved_length_m:42,loading_tail_m:6,recovery_extension_m:4.5},collector:'Six independently hinged reflective petals. Manufactured on the planet as a modular contribution to a future distributed Dyson collector structure, not a complete sphere.',optional_effect:'INSERTION_PLUME is a hidden-by-default preview mesh; replace or omit for game VFX.'},assets};
